...
So now we see that the user "Piedad Flatley" is a member of "Domain Admins" group which is an admin for computer "FLLABDC@TestCompany.Local". And this computer is a member of "ENTERPRISE DOMAIN CONTROLLERS" group.
